...
@section('content')
   <div class="container-fluid">
    ...
    <div class="col-md-6">
        <div class="d-flex align-items-center">
            ...
            <form method="GET" action="{{ request()->url() }}" class="d-flex align-items-center">
                ...
                <select name="per_page" id="entriesSelect" class="form-select form-select-sm" style="width: auto;" onchange="this.form.submit()">
    ...
    <div class="d-flex justify-content-start gap-2">
        <button class="btn btn-sm btn-warning flex-fill text-nowrap show-edit-form" data-ds="{{ $ds->ds_number }}">
            ✏️ 
        </button>
